  ...
  return (
    <div className={`space-y-4 max-w-xl mx-auto pb-20 relative z-10 ${glitching ? "animate-pulse filter invert contrast-200" : ""}`}>
      ...
      <div className="text-center space-y-0.5">
        <div className="text-sm font-bold font-serif text-indigo-200">
          第 0 篇 ｜ 多重宇宙的抉擇
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-1">
        <button
          onClick={handleYes}
          className="py-2.5 px-4 rounded-2xl border-2 border-purple-400 bg-purple-950/90 text-purple-100 text-xs font-bold font-serif shadow-lg shadow-purple-950/80 hover:bg-purple-900 flex items-center justify-center gap-1.5 group transition-all"
        >
          <span className="text-sm font-mono text-purple-300 font-extrabold">YES</span>
        ...
        <button
          onClick={handleNo}
          className="py-2.5 px-4 rounded-2xl border border-slate-700 bg-slate-900/80 text-slate-300 text-xs font-bold font-serif hover:bg-slate-800 flex items-center justify-center gap-1.5 transition-all"
        >
          <span className="text-sm font-mono text-slate-400 font-extrabold">NO</span>
      ...
      <div className="p-3 rounded-2xl border border-indigo-500/20 bg-slate-950/80 space-y-1.5 text-left">
        <div className="flex items-center justify-between text-[11px] font-mono text-slate-300">
          ...
          <span className="text-indigo-400 text-[10px] animate-pulse">GLITCH ALERT</span>
        </div>
      ...
      <div className="relative w-full h-[360px] sm:h-[400px] rounded-3xl overflow-hidden border-2 border-indigo-500/30 shadow-2xl bg-slate-950 group">
        ...
        <div className="absolute top-12 left-3 flex flex-col items-start space-y-1 text-left">
          <span className="text-xs font-bold font-serif text-purple-200 bg-purple-950/80 px-2 py-1 rounded-lg border border-purple-500/40 backdrop-blur-sm">
            探索未知
          </span>
          <span className="text-[10px] font-serif text-purple-300/80 bg-slate-950/80 px-1.5 py-0.5 rounded">
            不確定的未來
          </span>
        </div>

        <div className="absolute top-12 right-3 flex flex-col items-end space-y-1 text-right">
          <span className="text-xs font-bold font-serif text-slate-300 bg-slate-950/80 px-2 py-1 rounded-lg border border-slate-700 backdrop-blur-sm">
            維持輪迴
          </span>
          <span className="text-[10px] font-serif text-slate-400 bg-slate-950/80 px-1.5 py-0.5 rounded">
            重複的每一天
          </span>
        </div>
        ...
        <div className="absolute bottom-6 left-4 right-4 p-4 rounded-2xl border-2 border-purple-400/60 bg-slate-950/90 backdrop-blur-xl shadow-2xl text-left space-y-3">
          <div className="flex items-center justify-between text-[11px] font-mono text-purple-300 border-b border-purple-500/30 pb-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs font-serif text-purple-200/80">
              探索，YES / NO
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            <button
              onClick={handleYes}
              className="py-2 rounded-xl border border-purple-400 bg-purple-900/80 hover:bg-purple-800 text-purple-100 font-mono font-bold text-xs shadow-md transition-all active:scale-98 text-center"
            >
              YES
            </button>
            <button
              onClick={handleNo}
              className="py-2 rounded-xl border border-slate-700 bg-slate-900/80 hover:bg-slate-800 text-slate-400 font-mono font-bold text-xs transition-all text-center"
            >
              NO
            </button>
          </div>
      ...
      <div className="p-4 rounded-2xl border border-purple-500/30 bg-slate-900/95 backdrop-blur-xl shadow-2xl flex items-center justify-between gap-3 text-left">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs font-serif text-purple-100 leading-snug font-medium">
              「冷靜。你真的想要改變嗎？」
            </p>
          </div>
        </div>
