      ...
      <div className="relative w-full max-w-md p-6 rounded-3xl border border-amber-500/30 bg-slate-900/95 space-y-5 shadow-2xl">
        ...
        <div className="p-4 rounded-2xl bg-slate-950/80 border border-amber-500/20 space-y-2">
          <div className="flex items-center justify-between text-xs font-serif">
            <span className="text-slate-400">當前職銜：</span>
            <span className="text-amber-300 font-bold">{userProgress.detectiveRank}</span>
          </div>
          <div className="flex items-center justify-between text-xs font-serif">
            <span className="text-slate-400">破解案件總數：</span>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-950/60 border border-amber-500/20">
            <div className="flex items-center gap-2 text-xs font-serif text-amber-100 font-bold">
              {soundEnabled ? (
          ...
          <button
            onClick={onOpenAuth}
            className="w-full flex items-center justify-between p-3.5 rounded-2xl bg-slate-950/60 border border-amber-500/20 text-xs font-serif text-amber-100 font-bold hover:border-amber-400 transition-all"
          >
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-emerald-400" />
              <span>雲端同步狀態</span>
            </div>
            <span className="text-emerald-400 font-mono text-[11px]">重新登入同步</span>
          </button>
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-3.5 rounded-2xl bg-rose-950/30 border border-rose-500/20 text-xs font-serif text-rose-300 font-bold hover:bg-rose-900/40 transition-all"
          >
            <div className="flex items-center gap-2">
              <RefreshCw className="w-4 h-4 text-rose-400" />
              <span>重置偵探紀錄</span>
            </div>
            <span className="text-rose-400 text-[11px]">重新開始</span>
          </button>
        </div>

        <div className="text-[11px] font-serif text-slate-500 text-center pt-2">
