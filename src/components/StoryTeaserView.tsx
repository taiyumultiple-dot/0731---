    ...
    <div className="relative min-h-[80vh] flex flex-col items-center justify-between py-6 px-4 text-center max-w-xl mx-auto space-y-6">
      ...
      <div className="relative w-full h-[460px] sm:h-[520px] rounded-3xl overflow-hidden border-2 border-indigo-500/30 shadow-2xl bg-slate-950 group">
        ...
        <img
          src={IMG_TEASER}
          alt="多重宇宙的抉擇 前導預告"
          className="w-full h-full object-contain object-center filter contrast-125 saturate-110 opacity-90 group-hover:scale-105 transition-transform duration-700"
        />
        ...
        <div className="absolute top-4 left-4 right-4 flex justify-between items-center text-base font-mono text-purple-300/80 bg-slate-950/60 backdrop-blur-md px-3 py-1.5 rounded-full border border-purple-500/30">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end p-6 space-y-2">
          ...
          <div className="text-base font-serif font-bold text-purple-300/90 tracking-widest uppercase">
            ✦ 第0篇 ｜ 前導預告 ✦
          </div>
        </div>
      </div>
      ...
      <div className="w-full p-6 rounded-3xl border border-indigo-500/30 bg-slate-900/90 shadow-2xl backdrop-blur-xl space-y-4 text-center">
        ...
        <div className="space-y-2.5 pt-1">
          ...
          <button
            ...
            className="w-full py-3 px-6 rounded-2xl font-serif font-bold text-base text-indigo-200 bg-slate-950/80 hover:bg-slate-900 border border-indigo-500/30 transition-all flex items-center justify-center gap-1"
          >
            <span>繼續旅程</span>
        ...
        <div className="pt-2 text-base font-serif text-amber-300/80 flex items-center justify-center gap-1">
